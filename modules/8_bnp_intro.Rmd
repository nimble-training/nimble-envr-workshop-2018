...
Bayesian nonparametrics appeared as a beta feature in version 0.6-11 of NIMBLE, released in June, and is under very active development. At the moment, we have two standard representations of Bayesian nonparametric mixture models based on Dirichlet processes:
