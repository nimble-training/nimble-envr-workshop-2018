...
Here are the modules we'll work through for this short course.
 ...
 - Introduction to NIMBLE
    ...
    3. [Running an MCMC](modules/4_run_mcmc_slides.html) 
 - Customizing an MCMC and advanced model building
    4. [Customizing an MCMC](modules/4_customizing_mcmc_slides.html)
    5. [NIMBLE's dialect of BUGS](modules/5_nimble_bugs_slides.html)
    6. [User-defined distributions](modules/6_user_dist_slides.html)
    7. [Introduction to Dirichlet process models and nonparametric density estimation](modules/7_bnp_intro_slides.html)
    8. [Case study: Meta-analysis with nonparametric random effects](modules/8_meta_analysis_slides.html)
    9. [Case study: Meta-analysis with nonparametric random effects](meta_analysis_slides.html)
 ...
 - Programming algorithms in NIMBLE
    7. [nimbleFunction example: maximum (marginal) likelihood](modules/4.2_basic_nimbleFunction_slides.html) 
    8. [Operating a NIMBLE model](modules/4.4_operating_model_slides.html)
    9. [Inspecting model structure](modules/4.5_model_structure_slides.html)
    10. [Writing your own MCMC sampler](modules/5.2_user_sampler_slides.html)
