...
Here are the modules we'll work through for this short course.
 ...
 - Customizing an MCMC and advanced model building
    ...
    10. [Exercises: MCMC customization and building models](modules/10_exercises_slides.html) OR see mcmc customize slides or  modules/3.4_user_dist_exercises_slides.html
